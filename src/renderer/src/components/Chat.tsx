...
const MOCK_RESPONSES = [
    ...
    "Interesting! There are a few ways to approach this. The trade-offs mostly come down to simplicity vs. flexibility, depending on your priorities.",
...
export function Chat() {
    ...
    const modelLabel = config?.defaultLlm.defaultModel ?? "Assistant";
